      ...
      <div className="relative z-10 container mx-auto px-6 pt-16 pb-10">
        ...
        صفاء البيئة لجمع ونقل النفايات
          ...
          <p className="text-lg md:text-xl text-primary-foreground/90 font-body mb-6 max-w-2xl">
            Safaa Albea Waste Collection & Transport provides professional medical and biohazardous waste collection and transport services for healthcare facilities in Dubai. We support clinics, laboratories, pharmacies, dental clinics, schools, and medical centers with scheduled collection, safe handling, weighing records, and documented handover for approved disposal.
          </p>
